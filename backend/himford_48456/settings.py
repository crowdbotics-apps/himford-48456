"""
Django settings for himford_48456 project.
...
ROOT_URLCONF = 'himford_48456.urls'
...
WSGI_APPLICATION = 'himford_48456.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himford_48456 API",
    "DESCRIPTION": "API documentation for himford_48456 App",
    "VERSION": "v1",
}
